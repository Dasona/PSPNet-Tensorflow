...
tf.app.flags.DEFINE_string(
    'output_filename', 'model.pb', 'The filename of the protobuf')

tf.app.flags.DEFINE_integer(
    'num_classes', None, 'The number of output classes for the model')
...
def main(_):
  ...
  with tf.Graph().as_default() as g:
    ...
    #####################################
    image_X = tf.placeholder(tf.float32, (512, 473, 3), name='ph_input_x')
    ...
    softmax = tf.reshape(softmax, shape=(-1,512,473,num_classes), name='softmax')
